...
set_property -dict {PACKAGE_PIN AD36 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[0]];  # HA20_P
set_property -dict {PACKAGE_PIN AD37 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[1]];  # HA20_N
set_property -dict {PACKAGE_PIN AA34 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[2]];  # HA21_P
set_property -dict {PACKAGE_PIN AA35 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[3]];  # HA21_N
...
set_property -dict {PACKAGE_PIN Y35 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[4]];  # HA22_P
set_property -dict {PACKAGE_PIN AA36 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[5]];  # HA22_N
set_property -dict {PACKAGE_PIN Y37 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[6]]; # HA23_P
set_property -dict {PACKAGE_PIN AA37 IOSTANDARD LVCMOS18} [get_ports FMC2_J23[7]]; # HA23_N
